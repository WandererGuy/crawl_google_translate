...
def translate_api(sentence):
    ...
    curl_command = [
        "curl",
        "https://duckduckgo.com/translation.js?vqd=4-313577330634778978634865541073773533&query=google%20translate&from=en&to=th",
        "-H", "accept: */*",
...
if __name__ == "__main__":
    with open(r"input\train.en", "r", encoding="utf-8") as f:
        lines = f.readlines()
